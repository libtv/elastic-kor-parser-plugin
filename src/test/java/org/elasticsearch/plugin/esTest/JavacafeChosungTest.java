...
import org.elasticsearch.plugin.analysis.KoreanParserPlugin;
...
public class JavacafeChosungTest extends AbstractPluginTest {
    ...
    public void testChosungFilter() throws Exception {
        ...
        String filterName = "javacafe_chosung";
        

        // 실행
        TestAnalysis analysis = createTestAnalysis(
                new Index("test", ""), Settings.builder().build(), new KoreanParserPlugin()
        );
